...
**TPJ7軸評価基準とは、Third Place Japanが「いる体験の価値」を業種横断で評価するために独自に定めた7つの視点のことだ。居心地・静寂性・特別感・ストーリー・再訪価値・記録性・インバウンド適性からなり、TPJセレクト・認証グレードすべての評価言語として機能する、サードプレイス独自の共通言語である。**
