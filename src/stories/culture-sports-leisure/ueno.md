...
上野のサードプレイスとしての本質は、個々の文化施設の質ではなく、それらを束ねる公園という「器」が施設間の余白の時間を生み出している点にある。「どれかに行く」のではなく「公園ごと一日滞在する」という使い方が、上野を東京でも稀な文化複合サードプレイスにしている。サードプレイスジャパン（Third Place Japan）は、この複合性が支える再訪・継続価値を7軸評価基準で高く評価している。
